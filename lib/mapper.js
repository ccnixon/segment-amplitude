...
const map = function(event){
  ...
  // Establish an event property naming map. This would be defined in a UI and stored as a JSON object in a further iteration.
  // This map defines which Amplitude parameters would be equivalent to standard Segment event parameters.
  const eventMapping = {
    user_id          : 'userId',
